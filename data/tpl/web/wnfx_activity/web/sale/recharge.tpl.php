...
<div class="page-content">
    <form id="dataform" <?php  if(perm('sale.recharge')) { ?>action="" method="post"<?php  } ?> class="form-horizontal form-validate">
                    ...
                    <div class="input-group recharge-item fixmore-input-group" style="margin-top:5px">
                        ...
                        <div class="input-group-select">
                            <select name="credit[]" class="form-control">
                                <option value="0"<?php  if($item['credit']=='0') { ?> selected<?php  } ?>>元</option>
                                <option value="1"<?php  if($item['credit']=='1') { ?> selected<?php  } ?>><?php  echo m('member')->getCreditName('credit1')?></option>
                            </select>
                        </div>
