...
<script src="<?php  echo $_W['siteroot'];?>web/resource/js/lib/jquery-ui-1.10.3.min.js"></script>
<script charset="utf-8" src="//map.qq.com/api/js?v=2.exp&key=2SJBZ-MOXRX-ZNZ4C-ZHNJ2-EHRZT-RWFQ7"></script>
<style type="text/css">
#main{margin:0 auto;width:100%;height:445px;border:1px solid #5688cb;border-top:0;}
#tooles{position:relative;z-index:100;height:23px;background:#5688cb;color:#fff;}
#bside_left{float:left;overflow:auto;padding:10px 0 10px 10px;width:23.9%;height:410px;}
#bside_rgiht{float:left;margin-left:10px;width:75%;height:422px;border-left:1px solid #5688cb;font-size:9pt;}
#cur_city,#no_value{position:absolute;top:3px;left:10px;height:20px;}
...
.btn_copy{float:left;width:49px;height:24px;background:url(<?php echo FX_URL;?>web/resource/images/map/btn_cpoy.png) 0 0;}
...
#city{position:absolute;top:20px;left:0;z-index:999;overflow:auto;padding:10px;width:356px;height:410px;border:1px solid #d6d6d6;background:#fff;color:#000;}
#city .city_class{background:#fff;font-size:9pt;margin-top:0;}
...
#container{width:100%;height:420px;border:5px solid #fff;}
#container div div:nth-child(1){z-index:1!important;}
#container div div:nth-child(2){opacity:0}
#container.show div div:nth-child(2){opacity:1}
.smnoprint{z-index:2!important;}
#no_value{position:relative;width:200px;color:red;}
.form-group{margin-bottom:10px;}
.input-group .form-control{border-radius: 4px!important;border-top-right-radius: 0!important;border-bottom-right-radius: 0!important;}
</style>
</head>
<body>
...
<div class="form-group">
    <div class="search input-group">
        <input type="text" id="addr_cur" class="search_t form-control" onkeypress="if(event.keyCode==13) {btnSearch.click();return false;}"/>
        <div id="btn_search" class="input-group-btn"><button class="btn btn-default"><i class="icon-search"></i> 搜索</button></div>
    </div>
    <div class="poi">
...
var map = new qq.maps.Map(container, {
    ...
    cityservice = new qq.maps.CityService({
        complete: function (result) {
			...
			setTimeout(function(){
				$('#container').children("div").children("div").get(1).remove();
...
function setAnchor(marker, flag) {
    ...
    if (flag == true) {
        var anchor = new qq.maps.Point(10, 30),
                ...
                icon = new qq.maps.MarkerImage("<?php echo FX_URL;?>web/resource/images/map/marker10.png", size, origin, anchor);
        marker.setIcon(icon);
    } else {
        var anchor = new qq.maps.Point(10, 30),
