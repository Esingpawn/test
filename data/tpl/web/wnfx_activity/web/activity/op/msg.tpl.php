...
<form id="form-msg" class="form-horizontal form-ajax" action="" method="post" enctype="multipart/form-data" >
    ...
    <input type='hidden' name='ids' value='<?php  echo $rids;?>' />
	<div class="modal-dialog">
		<div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <div class="col-sm-<?php  if(!empty($rids)) { ?>12<?php  } else { ?>6<?php  } ?>">
                    ...
                    <div class="<?php  if(empty($rids)) { ?>col-sm-6<?php  } ?>"<?php  if(!empty($rids)) { ?> style=" width:0;overflow:hidden"<?php  } ?>>
                    <select class="form-control" name="fans_group"<?php  if(!empty($rids)) { ?> style="border:none"<?php  } ?>>
                        ...
                        <option value="5"<?php  if(!empty($rids)) { ?> selected<?php  } ?>>所有报名用户</option>
                    </select>
                    </div>
                </div>
                <div class="form-group">
