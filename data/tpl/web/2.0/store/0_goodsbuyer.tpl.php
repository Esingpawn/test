	...
	<div class="clearfix">
		<div class="search-box we7-margin-bottom">
			...
			<form action="" class="search-form " method="get">
				...
				<input type="hidden" name="module_name" value="store">
				...
				<div class="input-group" style="width: 400px;">
					<input type="text" name="keyword" value="<?php  echo $_GPC['keyword'];?>" class="form-control" placeholder="输入要搜索的应用名称"/>
	...
	<div class="wish-goods-list">
		...
		<a href="<?php  echo $this->createWebUrl('goodsbuyer', array('operate' => 'goods_info', 'direct' => 1, 'goods' => $goods['id']))?>" class="wish-goods-item">
			<div class="wish-goods-box">
				...
				<?php  } else if(in_array($goods['type'], array(STORE_TYPE_PACKAGE, STORE_TYPE_ACCOUNT, STORE_TYPE_WXAPP,STORE_TYPE_WEBAPP,STORE_TYPE_PHONEAPP,STORE_TYPE_ALIAPP,STORE_TYPE_BAIDUAPP,STORE_TYPE_TOUTIAOAPP, STORE_TYPE_ACCOUNT_RENEW, STORE_TYPE_WXAPP_RENEW, STORE_TYPE_WEBAPP_RENEW,STORE_TYPE_PHONEAPP_RENEW,STORE_TYPE_ALIAPP_RENEW,STORE_TYPE_BAIDUAPP_RENEW,STORE_TYPE_TOUTIAOAPP_RENEW, STORE_TYPE_USER_RENEW))) { ?>
...
<div class="panel-body js-goods-buyer" ng-controller="goodsBuyerCtrl">
		...
		<div class="wish-goods-info">
			...
			<div class="info">
				<div class="title">
					...
					创建<?php  echo $goods['platform_num'];?>个公众号
				...
				<div class="bg-gray">
					...
					<div class="creat">
						...
						<ul class="clearfloat">
							...
							<li>
								<div class="type"><div>字节跳动小程序</div><i class="wi wi-toutiaoapp"></i></div>
								<div class="num">
									<?php  if($goods['type'] == STORE_TYPE_ACCOUNT_PACKAGE) { ?>
	...
	<script>
	$(function() {
		$('.wish-goods-more .content img').on('load', function() {
			$('.wish-goods-more .content .more').show()
		...
		$('.wish-goods-pic .pic-item').on('click', function() {
			$('#modal-img .modal-body').html('<img style="max-width: 650px;max-height: 500px;" src=' + $(this).children('img').attr('src') + '>');
