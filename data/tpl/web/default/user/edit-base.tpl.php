...
<div id="js-user-edit-base" ng-controller="UserProfileDisplay" ng-cloak>
	...
	<table class="table we7-table table-hover table-form">
		...
		<tr ng-repeat="field in extra_fields">
			...
			<td ng-bind="profile[field.field]" ng-if="field.field != 'gender'"></td>
			<td ng-if="field.field == 'gender' && profile[field.field] == 0"></td>
			<td ng-if="field.field == 'gender' && profile[field.field] == 1">男</td>
			<td ng-if="field.field == 'gender' && profile[field.field] == 2">女</td>
	...
	<div class="modal fade" id="extra" role="dialog">
		<div class="we7-modal-dialog modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body" ng-if="edit_extra_filed.field == 'gender'">
					<select class="form-control" ng-model="edit_extra_filed[edit_extra_filed.field]">
						<option value="">请选择性别</option>
						<option value="1" ng-selected="edit_extra_filed.gender == 1">男</option>
						<option value="2" ng-selected="edit_extra_filed.gender == 2">女</option>
					</select>
				</div>
				<div class="modal-body" ng-if="edit_extra_filed.field != 'gender'">
					<div class="form-group">
						<input type="text" ng-model="edit_extra_filed[edit_extra_filed.field]" class="form-control" placeholder="{{ edit_extra_filed.title }}" />
						<span class="help-block"></span>
					</div>
				</div>
				<div class="modal-footer">
