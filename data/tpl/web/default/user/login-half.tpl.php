...
<div class="system-login-new system-login-new--half">
	<div class="login-bg-box" style="background-image: url(<?php  if(!empty($_W['setting']['copyright']['background_img'])) { ?> <?php  echo to_global_media($_W['setting']['copyright']['background_img']);?> <?php  } else { ?> './resource/images/bg-login-full.jpg' <?php  } ?>);"></div>
	<div class="head">
		...
		<form id="login-form" action="" method="post" class="we7-form">
			...
			<div class="text-center">
				...
				<div class="form-control-static login-other">
					<?php  if(!empty($setting['thirdlogin']['qq']['authstate'])) { ?>
					<a href="<?php  echo $login_urls['qq'];?>" class="item">
						<img src="./resource/images/qqlogin.png" width="35px">
						<p>QQ登录</p>
					</a><?php  } ?>
					<?php  if(!empty($setting['thirdlogin']['wechat']['authstate'])) { ?>
					<a href="<?php  echo $login_urls['wechat'];?>" class="item">
