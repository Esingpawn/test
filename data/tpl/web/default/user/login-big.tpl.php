...
<div class="system-login-new" style="background-image: url(<?php  if(!empty($_W['setting']['copyright']['background_img'])) { ?> <?php  echo to_global_media($_W['setting']['copyright']['background_img']);?> <?php  } else { ?> './resource/images/bg-login-full.jpg' <?php  } ?>);">
	<div class="head">
