...
<div id="js-user-edit-modulestpl" ng-controller="UserEditModules" ng-cloak>
	...
	<div class="panel we7-panel user-permission">
		<div class="panel-heading">
			<span>所属用户权限组合：<span ng-bind="group_info.name || '无用户组'"></span></span>
			...
			<div class="we7-modal-dialog modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<div class="modal-title">修改用户权限组合</div>
					</div>
					<div class="modal-body">
						<div class="form-group">
							<select class="we7-select" search="1" ng-model="changeGroup">
								<option value="0">请选择所属用户权限组合</option>
