...
<div class="new-keyword" id="js-user-post" ng-controller="UserCreateCtrl" ng-cloak>
	...
	<form class="we7-form user-create" name="UserCreateForm">
		<!-- 基本信息 start -->
		...
		<div ng-show="create_step == 2" class="user-create-permission">
			...
			<?php  if($user_type != 'vice_founder' && permission_check_account_user('see_user_create_own_vice_founder')) { ?>
			<div class="form-group">
		...
		<div class="col-sm-offset-2">
			<input type="button" ng-if="create_step == 1" ng-disabled="!UserCreateForm.username.$dirty || UserCreateForm.username.$invalid || !UserCreateForm.password.$dirty || UserCreateForm.password.$invalid || !UserCreateForm.repassword.$dirty || UserCreateForm.repassword.$invalid" value="下一步" class="btn btn-primary" ng-click="step(2)" ng-style="{'padding': '6px 50px'}"/>
			<input type="button"  ng-if="create_step == 2" value="上一步" class="btn btn-primary" ng-click="step(1)" ng-style="{'padding': '6px 50px'}"/>
			<input type="button" ng-if="create_step == 2" name="submit" ng-disabled="submitDisabled" value="提交" class="btn btn-primary" ng-click="submit()" ng-style="{'padding': '6px 50px'}"/>
