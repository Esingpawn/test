...
<div class="new-keyword">
	<ol class="breadcrumb we7-breadcrumb">
		<a href="<?php  echo url('platform/reply', array('module_name' => $m));?>"><i class="wi wi-back-circle"></i> </a>
		<li>
			<a href="<?php  echo url('platform/reply', array('module_name' => $m));?>">自动回复管理</a>
		</li>
		<li>
			<?php  if(empty($rid)) { ?><a href="<?php  echo url('platform/reply/post', array('module_name' => $m));?>">新建<?php  echo $module['title'];?></a></li><?php  } ?>
			<?php  if(!empty($rid)) { ?><a href="<?php  echo url('platform/reply/post', array('module_name' => $m, 'rid' => $rid))?>">编辑<?php  echo $module['title'];?></a></li><?php  } ?>
		</li>
	</ol>
