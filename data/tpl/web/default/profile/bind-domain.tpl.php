...
<div class="alert alert-info">
	...
	<p><i class="fa fa-exclamation-circle"></i> 如访问微站链接为<span class="color-gray"><?php  echo $_W['siteroot'];?>app/index.php?i=<?php  echo $_W['uniacid'];?>&c=home</span>，<br>&nbsp;&nbsp;&nbsp;&nbsp;绑定bang.baidu.com后，访问微站链接就成为<span class="color-gray"><?php  echo $_W['sitescheme'];?>bang.baidu.com/app/index.php?i=<?php  echo $_W['uniacid'];?>&c=home</span></p>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="form-group">
						<input type="text" ng-model="middleAccount.bind_domain" class="form-control" placeholder="请输入要绑定的域名，以http://或https://开头，注意结尾不要带 /" />
