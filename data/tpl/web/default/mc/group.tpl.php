...
<div class="alert we7-page-alert">
	<p><strong class="text-danger"><i class="wi wi-info-sign"></i> 管理员不能直接修改会员所在的会员组. 如果需要修改会员组,请通过设置积分来影响总积分,系统会根据影响后的总积分自动算出对应的会员组</strong></p>
	<p><i class="wi wi-info-sign"></i>默认会员组的积分需设置为 0</p>
	<p><i class="wi wi-info-sign"></i> 系统会根据会员的总积分多少自动对会员的分组进行调整</p>
</div>
