...
">修改</a></div>
		...
		<div class="member-credits-box">
			<div class="box-header">
				<a href="<?php  echo url('mc/member/member_credits', array('uid' => $uid, 'type' => 'credit1'))?>" class=" <?php  if($type == 'credit1') { ?>active<?php  } ?>"><?php  echo $creditnames['credit1']['title'];?>记录</a>
				<a href="<?php  echo url('mc/member/member_credits', array('uid' => $uid, 'type' => 'credit2'))?>" class=" <?php  if($type == 'credit2') { ?>active<?php  } ?>"><?php  echo $creditnames['credit2']['title'];?>记录</a>
				<a href="<?php  echo url('mc/member/export', array('uid' => $uid, 'type' => $type))?>" target="_blank" class="pull-right color-default">导出记录</a>
			</div>
			<table class="table we7-table table-hover table-form">
				<col width="140px">
				<col />
...
<div class="main" id="js-base-information" ng-controller="baseInformation" ng-cloak>
	<form action="" class="we7-form form" method="post" enctype="multipart/form-data">
		...
		<table class="table we7-table table-hover table-form">
			...
			<col width="100px">
			<tr>
				<th class="text-left" colspan="3"><?php  echo $uniacid_fields['bio']['title'];?></th>
			</tr>
			<tr>
		...
		<div class="modal fade" id="gender" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="we7-modal-dialog modal-dialog we7-form">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<div class="modal-title">修改<?php  echo $uniacid_fields['gender']['title'];?></div>
					</div>
					<div class="modal-body">
						<div class="form-group">
		...
		<div class="modal fade" id="nickname" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="we7-modal-dialog modal-dialog we7-form">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<div class="modal-title">修改<?php  echo $uniacid_fields['nickname']['title'];?></div>
					</div>
					<div class="modal-body">
						<div class="form-group">
							<input type="text" ng-model="userOriginal.nickname" class="form-control" placeholder="<?php  echo $uniacid_fields['nickname']['title'];?>" />
		...
		<div class="modal fade" id="realname" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="we7-modal-dialog modal-dialog we7-form">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<div class="modal-title">修改<?php  echo $uniacid_fields['realname']['title'];?></div>
					</div>
					<div class="modal-body">
						<div class="form-group">
							<input type="text" ng-model="userOriginal.realname" class="form-control" placeholder="<?php  echo $uniacid_fields['realname']['title'];?>" />
							<span class="help-block"></span>
						</div>
					</div>
					<div class="modal-footer">
		...
		<div class="modal fade" id="births" role="dialog">
			<div class="we7-modal-dialog modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<div class="modal-title">修改<?php  echo $uniacid_fields['birthyear']['title'];?></div>
					</div>
					<div class="modal-body">
						<div class="form-group">
		...
		<div class="modal fade" id="resides" role="dialog">
			<div class="we7-modal-dialog modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<div class="modal-title">修改<?php  echo $uniacid_fields['nationality']['title'];?></div>
					</div>
					<div class="modal-body">
						<div class="form-group">
		...
		<div class="modal fade" id="address" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="we7-modal-dialog modal-dialog we7-form">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<div class="modal-title">修改<?php  echo $uniacid_fields['resideprovince']['title'];?></div>
					</div>
					<div class="modal-body">
						<div class="form-group">
		...
		<div class="modal fade" id="mobile" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="we7-modal-dialog modal-dialog we7-form">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<div class="modal-title">修改<?php  echo $uniacid_fields['mobile']['title'];?></div>
					</div>
					<div class="modal-body">
						<div class="form-group">
							<input type="text" ng-model="userOriginal.mobile" class="form-control" placeholder="<?php  echo $uniacid_fields['mobile']['title'];?>" />
							<span class="help-block"></span>
						</div>
					</div>
					<div class="modal-footer">
		...
		<div class="modal fade" id="qq" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="we7-modal-dialog modal-dialog we7-form">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<div class="modal-title"><?php  echo $uniacid_fields['qq']['title'];?></div>
					</div>
					<div class="modal-body">
						<div class="form-group">
							<input type="text" ng-model="userOriginal.qq" class="form-control" placeholder="<?php  echo $uniacid_fields['qq']['title'];?>" />
							<span class="help-block"></span>
						</div>
					</div>
					<div class="modal-footer">
		...
		<div class="modal fade" id="email" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="we7-modal-dialog modal-dialog we7-form">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<div class="modal-title">修改<?php  echo $uniacid_fields['email']['title'];?></div>
					</div>
					<div class="modal-body">
						<div class="form-group">
							<input type="text" ng-model="userOriginal.email" class="form-control" placeholder="<?php  echo $uniacid_fields['email']['title'];?>" />
							<span class="help-block"></span>
						</div>
					</div>
					<div class="modal-footer">
		...
		<div class="modal fade" id="telephone" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="we7-modal-dialog modal-dialog we7-form">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<div class="modal-title">修改<?php  echo $uniacid_fields['telephone']['title'];?></div>
					</div>
					<div class="modal-body">
						<div class="form-group">
							<input type="text" ng-model="userOriginal.telephone" class="form-control" placeholder="<?php  echo $uniacid_fields['telephone']['title'];?>" />
							<span class="help-block"></span>
						</div>
					</div>
					<div class="modal-footer">
		...
		<div class="modal fade" id="msn" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="we7-modal-dialog modal-dialog we7-form">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<div class="modal-title">修改<?php  echo $uniacid_fields['msn']['title'];?></div>
					</div>
					<div class="modal-body">
						<div class="form-group">
							<input type="text" ng-model="userOriginal.msn" class="form-control" placeholder="<?php  echo $uniacid_fields['msn']['title'];?>" />
							<span class="help-block"></span>
						</div>
					</div>
					<div class="modal-footer">
		...
		<div class="modal fade" id="taobao" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="we7-modal-dialog modal-dialog we7-form">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<div class="modal-title">修改<?php  echo $uniacid_fields['taobao']['title'];?></div>
					</div>
					<div class="modal-body">
						<div class="form-group">
		...
		<div class="modal fade" id="alipay" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="we7-modal-dialog modal-dialog we7-form">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<div class="modal-title">修改<?php  echo $uniacid_fields['alipay']['title'];?></div>
					</div>
					<div class="modal-body">
						<div class="form-group">
							<input type="text" ng-model="userOriginal.alipay" class="form-control" placeholder="<?php  echo $uniacid_fields['alipay']['title'];?>" />
							<span class="help-block"></span>
						</div>
					</div>
					<div class="modal-footer">
		...
		<div class="modal fade" id="studentid" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="we7-modal-dialog modal-dialog we7-form">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<div class="modal-title">修改<?php  echo $uniacid_fields['studentid']['title'];?></div>
					</div>
					<div class="modal-body">
						<div class="form-group">
							<input type="text" ng-model="userOriginal.studentid" class="form-control" placeholder="<?php  echo $uniacid_fields['studentid']['title'];?>" />
							<span class="help-block"></span>
						</div>
					</div>
					<div class="modal-footer">
		...
		<div class="modal fade" id="grade" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="we7-modal-dialog modal-dialog we7-form">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<div class="modal-title">修改<?php  echo $uniacid_fields['grade']['title'];?></div>
					</div>
					<div class="modal-body">
						<div class="form-group">
							<input type="text" ng-model="userOriginal.grade" class="form-control" placeholder="<?php  echo $uniacid_fields['grade']['title'];?>" />
							<span class="help-block"></span>
						</div>
					</div>
					<div class="modal-footer">
		...
		<div class="modal fade" id="graduateschool" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="we7-modal-dialog modal-dialog we7-form">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<div class="modal-title">修改<?php  echo $uniacid_fields['graduateschool']['title'];?></div>
					</div>
					<div class="modal-body">
						<div class="form-group">
							<input type="text" ng-model="userOriginal.graduateschool" class="form-control" placeholder="<?php  echo $uniacid_fields['graduateschool']['title'];?>" />
							<span class="help-block"></span>
						</div>
					</div>
					<div class="modal-footer">
		...
		<div class="modal fade" id="education" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="we7-modal-dialog modal-dialog we7-form">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<div class="modal-title">修改<?php  echo $uniacid_fields['education']['title'];?></div>
					</div>
					<div class="modal-body">
						<div class="form-group">
		...
		<div class="modal fade" id="company" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="we7-modal-dialog modal-dialog we7-form">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<div class="modal-title">修改<?php  echo $uniacid_fields['company']['title'];?></div>
					</div>
					<div class="modal-body">
						<div class="form-group">
							<input type="text" ng-model="userOriginal.company" class="form-control" placeholder="<?php  echo $uniacid_fields['company']['title'];?>" />
							<span class="help-block"></span>
						</div>
					</div>
					<div class="modal-footer">
		...
		<div class="modal fade" id="occupation" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="we7-modal-dialog modal-dialog we7-form">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<div class="modal-title">修改<?php  echo $uniacid_fields['occupation']['title'];?></div>
					</div>
					<div class="modal-body">
						<div class="form-group">
							<input type="text" ng-model="userOriginal.occupation" class="form-control" placeholder="<?php  echo $uniacid_fields['occupation']['title'];?>" />
							<span class="help-block"></span>
						</div>
					</div>
					<div class="modal-footer">
		...
		<div class="modal fade" id="position" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="we7-modal-dialog modal-dialog we7-form">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<div class="modal-title">修改<?php  echo $uniacid_fields['position']['title'];?></div>
					</div>
					<div class="modal-body">
						<div class="form-group">
							<input type="text" ng-model="userOriginal.position" class="form-control" placeholder="<?php  echo $uniacid_fields['position']['title'];?>" />
							<span class="help-block"></span>
						</div>
					</div>
					<div class="modal-footer">
		...
		<div class="modal fade" id="revenue" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="we7-modal-dialog modal-dialog we7-form">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<div class="modal-title">修改<?php  echo $uniacid_fields['revenue']['title'];?></div>
					</div>
					<div class="modal-body">
						<div class="form-group">
							<input type="text" ng-model="userOriginal.revenue" class="form-control" placeholder="<?php  echo $uniacid_fields['revenue']['title'];?>" />
							<span class="help-block"></span>
						</div>
					</div>
					<div class="modal-footer">
		...
		<div class="modal fade" id="interest" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="we7-modal-dialog modal-dialog we7-form">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<div class="modal-title">修改<?php  echo $uniacid_fields['interest']['title'];?></div>
					</div>
					<div class="modal-body">
						<div class="form-group">
							<input type="text" ng-model="userOriginal.interest" class="form-control" placeholder="<?php  echo $uniacid_fields['interest']['title'];?>" />
							<span class="help-block"></span>
						</div>
					</div>
					<div class="modal-footer">
		...
		<div class="modal fade" id="lookingfor" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="we7-modal-dialog modal-dialog we7-form">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<div class="modal-title">修改<?php  echo $uniacid_fields['lookingfor']['title'];?></div>
					</div>
					<div class="modal-body">
						<div class="form-group">
							<input type="text" ng-model="userOriginal.lookingfor" class="form-control" placeholder="<?php  echo $uniacid_fields['lookingfor']['title'];?>" />
							<span class="help-block"></span>
						</div>
					</div>
					<div class="modal-footer">
		...
		<div class="modal fade" id="affectivestatus" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="we7-modal-dialog modal-dialog we7-form">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<div class="modal-title">修改<?php  echo $uniacid_fields['affectivestatus']['title'];?></div>
					</div>
					<div class="modal-body">
						<div class="form-group">
							<input type="text" ng-model="userOriginal.affectivestatus" class="form-control" placeholder="<?php  echo $uniacid_fields['affectivestatus']['title'];?>" />
							<span class="help-block"></span>
						</div>
					</div>
					<div class="modal-footer">
		...
		<div class="modal fade" id="site" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="we7-modal-dialog modal-dialog we7-form">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<div class="modal-title">修改<?php  echo $uniacid_fields['site']['title'];?></div>
					</div>
					<div class="modal-body">
						<div class="form-group">
							<input type="text" ng-model="userOriginal.site" class="form-control" placeholder="<?php  echo $uniacid_fields['site']['title'];?>" />
							<span class="help-block"></span>
						</div>
					</div>
					<div class="modal-footer">
		...
		<div class="modal fade" id="zipcode" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="we7-modal-dialog modal-dialog we7-form">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<div class="modal-title">修改<?php  echo $uniacid_fields['zipcode']['title'];?></div>
					</div>
					<div class="modal-body">
						<div class="form-group">
							<input type="text" ng-model="userOriginal.zipcode" class="form-control" placeholder="<?php  echo $uniacid_fields['zipcode']['title'];?>" />
							<span class="help-block"></span>
						</div>
					</div>
					<div class="modal-footer">
		...
		<div class="modal fade" id="idcard" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="we7-modal-dialog modal-dialog we7-form">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<div class="modal-title">修改<?php  echo $uniacid_fields['idcard']['title'];?></div>
					</div>
					<div class="modal-body">
						<div class="form-group">
		...
		<div class="modal fade" id="weight" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="we7-modal-dialog modal-dialog we7-form">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<div class="modal-title">修改<?php  echo $uniacid_fields['weight']['title'];?></div>
					</div>
					<div class="modal-body">
						<div class="form-group">
							<input type="text" ng-model="userOriginal.weight" class="form-control" placeholder="<?php  echo $uniacid_fields['weight']['title'];?>" />
							<span class="help-block"></span>
						</div>
					</div>
					<div class="modal-footer">
		...
		<div class="modal fade" id="height" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="we7-modal-dialog modal-dialog we7-form">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<div class="modal-title">修改<?php  echo $uniacid_fields['height']['title'];?></div>
					</div>
					<div class="modal-body">
						<div class="form-group">
							<input type="text" ng-model="userOriginal.height" class="form-control" placeholder="<?php  echo $uniacid_fields['height']['title'];?>" />
							<span class="help-block"></span>
						</div>
					</div>
					<div class="modal-footer">
		...
		<div class="modal fade" id="nationality" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="we7-modal-dialog modal-dialog we7-form">
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="form-group">
							<input type="text" ng-model="userOriginal.nationality" class="form-control" placeholder="<?php  echo $uniacid_fields['nationality']['title'];?>" />
							<span class="help-block"></span>
						</div>
					</div>
					<div class="modal-footer">
		...
		<div class="modal fade" id="constellation" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="we7-modal-dialog modal-dialog we7-form">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<div class="modal-title">修改<?php  echo $uniacid_fields['constellation']['title'];?></div>
					</div>
					<div class="modal-body">
						<div class="form-group">
		...
		<div class="modal fade" id="zodiac" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="we7-modal-dialog modal-dialog we7-form">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<div class="modal-title">修改<?php  echo $uniacid_fields['zodiac']['title'];?></div>
					</div>
					<div class="modal-body">
						<div class="form-group">
		...
		<div class="modal fade" id="bloodtype" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="we7-modal-dialog modal-dialog we7-form">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						<div class="modal-title">修改<?php  echo $uniacid_fields['bloodtype']['title'];?></div>
					</div>
					<div class="modal-body">
						<div class="form-group">
