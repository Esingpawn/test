...
$config['db']['master']['username'] = 'hdh_sxwelink_com';
$config['db']['master']['password'] = 'JMzAP5R4sd2erPLd';
$config['db']['master']['port'] = '3306';
$config['db']['master']['database'] = 'hdh_sxwelink_com';
...
$config['setting']['authkey'] = '06b1d3cb';
